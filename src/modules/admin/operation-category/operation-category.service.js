import model from '#models/operation-category.model';
...
const list = async (req, params) => {
  ...
  return {
    code: HTTP_STATUS.OK,
    message: 'operation categories has been fetched successfully.',
    data: result,
  };
};
...
const create = async (req, params) => {
  ...
  return {
    code: HTTP_STATUS.OK,
    message: 'operation category has been created successfully.',
    data: result,
  };
};
...
const update = async (req, params) => {
  ...
  return {
    code: HTTP_STATUS.OK,
    message: 'operation category has been updated successfully.',
    data: result,
  };
};
...
const remove = async (req, params) => {
  ...
  return {
    code: HTTP_STATUS.OK,
    message: 'operation category has been deleted successfully.',
    data: result,
  };
};
