 ...
 * @returns {(qb: import("knex").Knex.QueryBuilder<{}, any>) => import("knex").Knex.QueryBuilder<any, any>} - A export function that applies the filter to a query builder instance.
 *
